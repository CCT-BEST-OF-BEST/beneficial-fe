  ...
  return (
    <>
      <section className="mb-16">
        ...
        <h1 className="font-one-mobile-pop text-orange-primary text-shadow-white-4px text-center text-[60px]">
          이로운 한글
        </h1>
      </section>

      <section className="gap-y-7.5 grid flex-1 grid-cols-[55%_44%] grid-rows-2 gap-x-10">
        <Link to={'/study'} className="row-span-2 flex flex-col rounded-xl bg-[#FFB14E] px-7 py-6">
          <div className="mb-5 ml-5 mt-auto text-left">
